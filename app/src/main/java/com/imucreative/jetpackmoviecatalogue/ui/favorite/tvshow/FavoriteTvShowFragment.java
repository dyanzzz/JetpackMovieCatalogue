package com.imucreative.jetpackmoviecatalogue.ui.favorite.tvshow;
...
public class FavoriteTvShowFragment extends Fragment implements FavoriteFragmentCallback {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (getActivity() != null) {
            ...
            viewModel.setType(getString(R.string.favorite_tv_show));
            viewModel.entity.observe(getViewLifecycleOwner(), tvShows -> {
    ...
    private FavoriteTvShowViewModel obtainViewModel(FragmentActivity activity) {
        ...
        return new ViewModelProvider(activity, factory).get(FavoriteTvShowViewModel.class);
    }
