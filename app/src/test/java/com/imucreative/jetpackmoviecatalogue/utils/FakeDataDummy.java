...
public class FakeDataDummy {
    ...
    public static List<MovieEntity> getMovies(String category) {
        ...
        for (String[] data : data) {
            if(data[3].equals(category)) {
                ...
                movie.setTvShow(data[3]);
                movie.setDescription(data[4]);
                movie.setImagePath(data[5]);
                movies.add(movie);
            }
        }
        return movies;
    ...
    public static List<MovieResponse> getRemoteMovies(String category) {
        ...
        for (String[] data : data) {
            if(data[3].equals(category)) {
                ...
                movie.setTitle(data[1]);
                movie.setDate(data[2]);
                movie.setOriginalLanguage(data[3]);
                movie.setOverview(data[4]);
                movie.setPosterPath(data[5]);
                movies.add(movie);
            }
        }
        return movies;
    ...
    public static List<MovieEntity> getTvShows(String category) {
        List<MovieEntity> tvShows = new ArrayList<>();
        MovieEntity tvShow;
        for (String[] data : data) {
            if(data[3].equals(category)) {
                tvShow = new MovieEntity();
                tvShow.setMovieId(Integer.parseInt(data[0]));
                tvShow.setTitle(data[1]);
                tvShow.setDate(data[2]);
                tvShow.setTvShow(data[3]);
                tvShow.setDescription(data[4]);
                tvShow.setImagePath(data[5]);
                tvShows.add(tvShow);
            }
        }
        return tvShows;
    ...
    public static List<MovieResponse> getRemoteTvShows(String category) {
        List<MovieResponse> tvShows = new ArrayList<>();
        MovieResponse tvShow;
        for (String[] data : data) {
            if(data[3].equals(category)) {
                tvShow = new MovieResponse();
                tvShow.setId(Integer.parseInt(data[0]));
                tvShow.setTitle(data[1]);
                tvShow.setDate(data[2]);
                tvShow.setOriginalLanguage(data[3]);
                tvShow.setOverview(data[4]);
                tvShow.setPosterPath(data[5]);
                tvShows.add(tvShow);
            }
        }
        return tvShows;
